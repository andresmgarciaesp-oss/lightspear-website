...
export default function LightSpearWebsite() {
  return (
        ...
        <div className="mx-auto max-w-7xl rounded-[2rem] bg-yellow-400 p-10 text-black md:p-16">
          <div className="grid gap-10 md:grid-cols-3">
            <div>
              ...
              <p className="mt-2">Share your production dates, location, and equipment needs.</p>
            </div>
            <div>
              <p className="text-5xl font-bold">02</p>
              <h3 className="mt-4 text-xl font-bold">Confirm</h3>
              <p className="mt-2">We prepare availability, package details, and rental terms.</p>
            </div>
            <div>
              <p className="text-5xl font-bold">03</p>
              <h3 className="mt-4 text-xl font-bold">Produce</h3>
              <p className="mt-2">Your production receives professional equipment ready for use.</p>
            </div>
          </div>
        </div>
      </section>
